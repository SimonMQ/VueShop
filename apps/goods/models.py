...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self", null=True, blank=True, verbose_name="父目录级别", help_text="父目录", related_name="sub_cat", on_delete=models.CASCADE)
...
class GoodsCategoryBrand(models.Model):
    ...
    image = models.ImageField(max_length=20, upload_to="brands/")
